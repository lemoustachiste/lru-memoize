 ...
 *   retrieved from cache, thereby extending the expiration date of the entry.
  * @param {boolean} [cacheOptions.disposeOnGet=false] - When set to true
 *   entries will be removed from cache before they're returned. This is to only
